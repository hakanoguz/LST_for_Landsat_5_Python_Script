"""
  LST CALCULATOR FOR LANDSAT 5
  
  Updated on: 17 September 2022
  Written by HaKaN OGUZ
  Description: This python script calculates land surface temperature (LST) from Landsat 5 satellite imagery 
"""

import arcpy
from sys import argv

def CalculateLSTfromLandsat5TM(band3, band4, band6, Lmin_3=-1.17, Lmax_3=264, QCALMIN_3=1, QCALMAX_3=255, Lmin_4=-1.51, Lmax_4=221, QCALMIN_4=1, QCALMAX_4=255, Dark_Obj_DN_Value_for_Band3=9.5, Dark_Obj_DN_Value_for_Band4=7.3, Sun_Elevation=59.81, ES_Dist=1.0155, Lmin_6=1.2378, Lmax_6=15.303, QCALMIN_6=1, QCALMAX_6=255, Upwelling=2.43, Downwelling=3.85, Atmospheric_Transmissivity=0.79, LST="C:\\Landsat_8\\LST"):  # Calculate LST from Landsat 5 TM
...
if __name__ == '__main__':
    ...
    with arcpy.EnvManager(scratchWorkspace=r"C:\Users\h_ogu\Documents\ArcGIS\Projects\MyProject5\MyProject5.gdb", workspace=r"C:\Users\h_ogu\Documents\ArcGIS\Projects\MyProject5\MyProject5.gdb"):
        CalculateLSTfromLandsat5TM(*argv[1:])
